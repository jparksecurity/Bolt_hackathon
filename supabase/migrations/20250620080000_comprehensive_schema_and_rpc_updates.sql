-- =====================================================
-- COMPREHENSIVE SCHEMA AND RPC UPDATES
-- =====================================================
-- This migration consolidates multiple related changes:
...
-- 7. CLIENT TOUR AVAILABILITY RPC AND RLS UPDATES
-- =====================================================
...
-- 8. UPDATE ALL PUBLIC FUNCTIONS WITH PROPER ENUM TYPES
-- =====================================================

-- Drop and recreate get_public_project function with proper enum types and all missing fields
