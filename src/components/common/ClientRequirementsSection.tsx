...
> = ({ requirements, loading, readonly = false, onSave, onDelete }) => {
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {requirementCategories.map((category) => {
              const categoryRequirements = getRequirementsByCategory(
                category.id,
              );
              return (
                <div key={category.id}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setFormData({ ...formData, requirement_text: e.target.value })
              }
