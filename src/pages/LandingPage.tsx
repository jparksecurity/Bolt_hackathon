    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="hero-content">
          <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
            ...
            <h1 className="hero-title">
              ...
              <span className="text-gradient block hero-subtitle">
                Every Step of the Way.
              </span>
            </h1>
            <p className="hero-description">
              JIGO Dash is a private dashboard that helps brokers update clients
              on leasing projects, tour schedules, documents, and what's next—so
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <section className="py-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              What Your Clients Get with JIGO Dash
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="feature-card group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Keep clients in the loop with daily notes and progress updates
                throughout the entire leasing process.
              </p>
            </div>
            ...
            <div className="feature-card group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Let them know where and when they'll be visiting spaces with
                detailed tour schedules and locations.
              </p>
            </div>
            ...
            <div className="feature-card group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Share LOIs, floor plans, comps, and more—no more email digging
            ...
            <div className="feature-card group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Clients always know what's next in the lease process with
            ...
            <div className="feature-card group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Feel like they're being walked through, not left in the dark
        ...
        <section className="py-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              From Tour to Lease—Transparent Every Step
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                1. Broker Creates Project Dashboard
              </h3>
              <p className="text-gray-600">
                Set up a dedicated project space with all client requirements
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                2. Client Receives Private Link
              </h3>
              <p className="text-gray-600">
                Secure, personalized access to their project dashboard with
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                3. Broker Posts Updates + Uploads Docs
              </h3>
              <p className="text-gray-600">
                Real-time updates, document sharing, and tour scheduling all in
                one place.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                4. Client Follows Along with Full Visibility
              </h3>
              <p className="text-gray-600">
                Complete transparency throughout the leasing process builds
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Why Elite Brokers Choose Our Platform
              </h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Exclusive platform reserved for vetted, top-performing
                      commercial real estate professionals with proven track
                      records.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Sophisticated tools and white-glove service capabilities
                      that match the expectations of Fortune 500 clients and
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Bank-level security and confidentiality protocols to
                      protect sensitive deal information and client data.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8">
                  Join the most exclusive commercial real estate platform
